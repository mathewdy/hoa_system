...
<body class="min-h-screen md:bg-gray-50 flex flex-col">
  ...
  <div class="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Reset your HOAConnect password</h2>
      <p class="mt-2 text-center text-sm text-gray-600">Enter your email to receive reset instructions</p>
    </div>
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div class="mt-8 text-center">
          <a href="<?= BASE_PATH . '/index.php'?>" class="inline-flex items-center text-sm font-medium text-teal-600 hover:text-teal-500">
