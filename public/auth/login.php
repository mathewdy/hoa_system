...
<body class="min-h-screen md:bg-gray-50 flex flex-col">
  ...
  <div class="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Log in to HOAConnect</h2>
      <p class="mt-2 text-center text-sm text-gray-600">Access your Mabuhay Homes 2000 account</p>
    </div>
      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <form id="login-form" class="login-form space-y-6">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="<?= BASE_PATH . 'app/public/auth/forgot-password.php'?>" class="font-medium text-teal-600 hover:text-teal-500">
  ...
  <?php echo '<script type="module" src="'. BASE_URL .'ui/modules/auth/authenticate.js"></script>'; ?>
  </body>
</html>