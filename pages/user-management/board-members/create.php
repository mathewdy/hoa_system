            ...
            <div class="border-2 border-gray-200 px-8 py-6 rounded-lg shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    ...
                    <div class="grid grid-cols-2 items-center">
                      ...
                      <input type="text" name="village" value="Your Village Name" readonly class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500 px-3 py-2">
                    </div>
                </div>
            </div>
