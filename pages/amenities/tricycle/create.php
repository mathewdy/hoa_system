...
<div>
    <div class="rounded-lg shadow-sm">
        <div class="mb-5 border-b-2 border-gray-300 pb-4">
            <h3 class="text-2xl font-medium text-gray-900 leading-none">Create TODA</h3>
            <p class="text-gray-600">Register a new tricycle operator driver association</p>
        </div>

        <form id="createTodaForm" class="space-y-4" method="POST" enctype="multipart/form-data">
            ...
            <div class="border-2 border-gray-200 px-8 py-6 rounded-lg shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    ...
                    <div class="grid grid-cols-2 items-center">
                        ...
                        <input type="text" name="toda_name" required
                    ...
                    <div class="grid grid-cols-2 items-center">
                        ...
                        <input type="number" name="no_of_tricycles" required min="0"
                            class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm 
                                   focus:ring-teal-500 focus:border-teal-500 px-3 py-2">
                    </div>
                    ...
                    <div class="grid grid-cols-2 items-center">
                        ...
                        <input type="tel" name="contact_no" required pattern="09[0-9]{9}" placeholder="09123456789"
                            class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm 
                                   focus:ring-teal-500 focus:border-teal-500 px-3 py-2">
                    </div>
                    ...
                    <div class="grid grid-cols-2 items-center">
                        ...
                        <input type="number" name="fee_amount" required min="0" step="0.01"
                            class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm
                                   focus:ring-teal-500 focus:border-teal-500 px-3 py-2">
                    </div>
            ...
            <!-- OPERATION DETAILS -->
            <div class="border-2 border-gray-200 px-8 py-6 rounded-lg shadow-sm mt-6">
