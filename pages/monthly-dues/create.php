            ...
            <div class="border-2 border-gray-200 px-8 py-6 rounded-lg shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                    ...
                    <div class="grid grid-cols-2 items-center">
                        <label class="block text-sm font-medium text-gray-700">Due Name <span class="text-red-500">*</span></label>
                        <input type="text" name="due_name" required class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500 px-3 py-2" placeholder="e.g. Monthly Association Dues">
                    </div>

                    <div class="grid grid-cols-2 items-center">
                        <label class="block text-sm font-medium text-gray-700">Amount (₱) <span class="text-red-500">*</span></label>
                        <input type="number" name="amount" step="0.01" min="0" required class="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:ring-teal-500 focus:border-teal-500 px-3 py-2" placeholder="0.00">
                    </div>
                </div>
            </div>
...
$pageScripts = '
<script type="module" src="' . BASE_URL . 'ui/modules/monthly-dues/post.dues.js"></script>
';
