...
<body class="">
  <div class="h-full flex bg-gray-50">
    ...
    <div class="flex-1 flex flex-col">
      ...
      <main class="flex-1 p-6">
        <div class="mt-1">
          <h3 class="text-2xl font-medium text-gray-900 mb-4">Homeowners</h3>
          <div class="flex flex-row align-middle mb-4 gap-2">
            ...
            <div class="flex">
              <a 
                href="create.php?role=6" 
                class="md:mb-0 text-white bg-teal-600 hover:bg-teal-800 focus:ring-1 focus:outline-none focus:ring-teal-600 font-medium rounded-lg text-sm px-5 py-1.5 text-center items-center"
              >
  ...
  <?php 
    echo '
      ...
      <script src="'. BASE_PATH .'/assets/js/users/home-owners/fetch.js"></script>
    '; 
  ?>
  </body>
</html>
