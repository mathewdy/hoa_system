...
if ($search !== '') {
    $where = "AND (n.post_title LIKE ? OR n.description LIKE ? OR u.first_name LIKE ? OR u.last_name LIKE ? OR n.date_created LIKE ?)";
...
$sql = "SELECT n.*, CONCAT(u.first_name,' ',u.last_name) AS full_name
        FROM news_feed n
        LEFT JOIN user_info u ON n.created_by = u.user_id
        WHERE 1=1 $where
