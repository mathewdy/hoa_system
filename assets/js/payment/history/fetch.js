...
function fetchPaymentHistory(page = 1) {
  ...
  $.ajax({
    url: `/hoa_system/core/payments/getHistory.php`,
    type: 'GET',
    dataType: 'json',
    data: { 
      page, 
    ...
    success: function(res) {
      if (res.success) {
        ...
        state.set({ loading: false, error: res.message || 'Failed to load users.', users: [] });
      }
    },
    error: function() {
    ...
    users.forEach(user => {
      ...
      $tableBody.append(`
        <tr class="bg-white border-b border-gray-200 hover:bg-gray-100">
          ...
          <td class="px-6 py-4">
            <a href="payments.php?user_id=${user.user_id}"
