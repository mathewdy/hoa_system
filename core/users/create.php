...
//       sendResponse(false, 'First name, last name, email, and role are required.');
//   }
...
//       $stmt,
//       "issssssssissssssss",
//       $role_id, $user_id, $first_name, $middle_name, $last_name, $name_suffix,
...
if(isset($_POST['create_account'])){
  ...
  $sql_create_account = "INSERT INTO users (
    ...
    '$role', '$user_id', '$first_name', '$middle_name', '$last_name', '$name_suffix',
    '$email', '$hoa_number', '$phone', '$age', '$date_of_birth', '$citizenship',
    '$civil_status', 0, '$home_address', '$lot_number', '$block_number',
    '$phase_number', '$village_name', NOW(), NOW()
  )";

  // Execute query
  $run_sql_create_account = mysqli_query($conn, $sql_create_account);

  // Check query success and return a response
