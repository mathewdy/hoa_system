...
$sidebarItems = [
  ...
  'President' => [
    ...
    ['label' => 'Fee Type', 'icon' => 'ri-file-list-line', 'url' => BASE_PATH . 'app/pages/fees/types/list.php'],
    ['label' => 'Resolution', 'icon' => 'ri-file-paper-line', 'url' => BASE_PATH . 'app/pages/resolution/list.php'],
    ['label' => 'Liquidation of Expenses', 'icon' => 'ri-money-dollar-box-line', 'url' => BASE_PATH . 'app/pages/liquidation-of-expenses/list.php'],
    ['label' => 'Ledger', 'icon' => 'ri-book-line', 'url' => BASE_PATH . 'app/pages/ledger/list.php'],
    ['label' => 'Remittance', 'icon' => 'ri-wallet-line', 'url' => BASE_PATH . 'app/pages/remittance/list.php'],
    ['label' => 'Payment History', 'icon' => 'ri-history-line', 'url' => BASE_PATH . 'app/pages/payment/history/list.php'],
    ...
    ['label' => 'News Feed', 'icon' => 'ri-news-line', 'url' => BASE_PATH . 'app/pages/news/feed.php'],
    ['label' => 'Calendar', 'icon' => 'ri-calendar-line', 'url' => BASE_PATH . 'app/pages/calendar.php']
  ],

  'Admin' => [
    ['label' => 'Dashboard', 'icon' => 'ri-dashboard-line', 'url' => BASE_PATH . 'app/pages/dashboard.php'],
    ['label' => 'User Management', 'icon' => 'ri-user-settings-line', 'url' => BASE_PATH . 'app/pages/user-management/home-owners/list.php'],
    ['label' => 'Payment', 'icon' => 'ri-wallet-line', 'submenu' => [
        ['label' => 'Fee Type', 'icon' => 'ri-file-list-line', 'url' => BASE_PATH . 'app/pages/fees/types/list.php'],
        ['label' => 'Fee Assignation', 'icon' => 'ri-file-add-line', 'url' => BASE_PATH . 'app/pages/fees/assignations/list.php'],
        ['label' => 'Payment Verification', 'icon' => 'ri-checkbox-line', 'url' => BASE_PATH . 'app/pages/payment/verification/list.php'],
        ['label' => 'Remittance', 'icon' => 'ri-wallet-line', 'url' => BASE_PATH . 'app/pages/remittance/list.php'],
        ['label' => 'Payment History', 'icon' => 'ri-history-line', 'url' => BASE_PATH . 'app/pages/payment/history/list.php'],
    ]],
    ['label' => 'Amenities', 'icon' => 'ri-building-line', 'submenu' => [
    ...
    ['label' => 'Ledger', 'icon' => 'ri-book-line', 'url' => BASE_PATH . 'app/pages/ledger/list.php'],
    ['label' => 'News Feed', 'icon' => 'ri-news-line', 'url' => BASE_PATH . 'app/pages/news/feed.php'],
    ['label' => 'Receipt', 'icon' => 'ri-file-copy-line', 'url' => BASE_PATH . 'app/pages/receipt/list.php'],
    ['label' => 'Calendar', 'icon' => 'ri-calendar-line', 'url' => BASE_PATH . 'app/pages/calendar.php'],
  ],
