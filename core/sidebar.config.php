...
$sidebarItems = [
    ...
    'President' => [
        ...
        ['label' => 'Admin Management', 'icon' => 'ri-admin-line', 'url' => BASE_PATH . 'app/pages/user-management/accounts.php'],
        ['label' => 'Homeowners', 'icon' => 'ri-user-line', 'url' => BASE_PATH . 'app/pages/homeowners.php'],
        ...
        ['label' => 'Activity Logs', 'icon' => 'ri-list-check', 'url' => BASE_PATH . 'app/pages/activity_logs.php'],
        ['label' => 'Profile', 'icon' => 'ri-user-settings-line', 'url' => BASE_PATH . 'app/pages/profile.php'],
    ],
