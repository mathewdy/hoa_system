...
$(document).ready(function () {
  const $form = $('#setup-password-form');
  ...
  $form.on('submit', function (e) {
    ...
    $.ajax({
      url: '/hoa_system/app/api/auth/setup.php',
      type: 'POST',
      data: $form.serialize(),
      dataType: 'json',
      timeout: 10000,
  ...
  function render() {
    ...
    $btn.html(state.loading
      ? `
        <svg class="inline w-5 h-5 text-gray-200 animate-spin fill-teal-600 me-3" viewBox="0 0 100 101">
