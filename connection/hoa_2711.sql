...
(1, 'Magni anim tempor re', 2147483647, 55, '1979-10-28 00:00:00', '1994-01-20 00:00:00', 57, 'Porro quisquam eum q', 0, '2025-11-23', '0000-00-00'),
(2, 'Harum sit incidunt', 2147483647, 24, '1975-08-26 00:28:00', '1999-07-17 01:22:00', 47, 'Eligendi consequatur', 0, '2025-11-25', '0000-00-00');
...
INSERT INTO `fees` (`id`, `user_id`, `due_id`, `fee_type_id`, `fee_name`, `amount`, `status`, `next_due_date`, `date_created`, `date_updated`) VALUES
(9, '20251547', 1, 1, 'sample', 15000, 0, '2025-12-01', '2025-11-26', '0000-00-00'),
(10, '20251547', 2, 1, 'sample2', 15000, 0, '2025-12-01', '2025-11-26', '0000-00-00'),
(11, '20255366', 1, 1, 'sample', 15000, 0, '2025-12-01', '2025-11-27', '0000-00-00'),
(12, '20255366', 2, 1, 'sample2', 15000, 0, '2025-12-01', '2025-11-27', '0000-00-00'),
(13, '20255366', 3, 1, 'Sample Fee', 13, 0, '2025-12-01', '2025-11-27', '0000-00-00'),
(14, '20255366', 4, 1, 'Sample Fee 2', 13, 0, '2025-12-01', '2025-11-27', '0000-00-00');
...
(20, '20251547', '17', 'Mollit ut maxime qui', 'Voluptatem Pariatur', 'Aperiam nihil perspi', 'Adipisci accusantium', 'Mabuhay Village'),
(21, '20255366', '690', 'Modi neque maiores n', 'Optio incididunt er', 'Repellendus Laudant', 'Officiis alias sint', 'Mabuhay Village');
...
INSERT INTO `monthly_dues` (`id`, `due_name`, `amount`, `status`, `date_created`, `date_updated`) VALUES
(1, 'sample', 15000, 1, '0000-00-00', '0000-00-00'),
(2, 'sample2', 15000, 1, '2025-11-22', '0000-00-00'),
(3, 'Sample Fee', 13, 1, '2025-11-27', '0000-00-00'),
(4, 'Sample Fee 2', 13, 1, '2025-11-27', '0000-00-00');
...
INSERT INTO `payment_verification` (`id`, `created_by`, `payment_method`, `amount_paid`, `reference_number`, `is_walk_in`, `attachment`, `is_approve`, `is_submitted`, `date_created`) VALUES
(21, 20251547, 'Cash', 0, '2314234', 1, '0', 1, 0, '2025-11-26 21:48:42');
...
INSERT INTO `stalls` (`id`, `stall_no`, `status`) VALUES
(1, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `stall_rent`
--
...
--
-- Dumping data for table `stall_rent`
--

INSERT INTO `stall_rent` (`id`, `renter`, `contact_no`, `stall_id`, `date_start`, `date_end`, `amount`, `status`, `date_created`, `date_updated`) VALUES
(1, 'Danielle Hill', 2147483647, 1, '1984-04-26', '2004-11-13', 38, 0, '2025-11-23', '0000-00-00');
...
INSERT INTO `tricycle` (`id`, `toda_name`, `no_of_tricycles`, `status`, `date_start`, `date_end`, `representative`, `contact_no`, `date_created`, `date_updated`) VALUES
(1, 'Glenna Duncan', 48, 1, '1973-01-06', '1991-11-23', 'Quas sunt dicta id v', 2147483647, '2025-11-25', '0000-00-00');
...
(66, 6, '20251547', 'mytaw@mailinator.com', '$2y$10$8GnB/MijbS9bUjTuZqPose4ORpmF58.Wj3lu1XaUpCYMI8m5y/LFG', 0, '', NULL, 1, '2025-11-26', '0000-00-00'),
(67, 6, '20255366', 'mefaxoceky@mailinator.com', '$2y$10$//m/1Wz0LiC.aQ3DvUqivO3KfMn8JBkNiW8Bf9hpWt5.8TvyicBem', 0, '', NULL, 1, '2025-11-27', '0000-00-00');
...
(16, '20251547', 'Nadine', 'Anika Cash', 'Holder', 'Consequuntur in labo', '09567521753', '1974-02-12', 'Filipino', 'Single'),
(17, '20255366', 'Ursa', 'Teegan Roberts', 'Mccray', 'Eum consequatur veli', '09565555555', '1979-07-22', 'Filipino', 'Single');
...
--
-- Indexes for table `stall_rent`
--
ALTER TABLE `stall_rent`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `stall_rent`
--
ALTER TABLE `stall_rent`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
