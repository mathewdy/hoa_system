...
<div class="min-h-screen flex">
  ...
  <a href="sec-create-project-resolution.php">Create Project Resolution</a>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="sec-project-details.php?id=<?php echo $row_resolution['id']?>">Project Details</a>
              </td>
              <td>
                  <?php 
                      if (!empty($row_resolution['is_budget_released']) && $row_resolution['is_budget_released'] == 1) {
                          echo '<a href="sec-budget-release.php?id=' . $row_resolution['id'] . '">Budget Release</a>';
                      }
                  ?>
              </td>
              <td>
                  <?php 
                      if (!empty($row_resolution['has_financial_summary']) && $row_resolution['has_financial_summary'] == 1) {
                          echo '<a href="sec-financial-summary.php?id=' . $row_resolution['id'] . '">Financial Summary</a>';
                      }
                  ?>
              </td>
            </tr>
