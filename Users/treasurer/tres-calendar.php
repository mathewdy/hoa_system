...
<body class="bg-gray-50">
  <div class="min-h-screen flex">
     <!-- Sidebar -->
     <div id="sidebar" class="bg-teal-800 text-white w-64 py-6 flex flex-col md:static fixed inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out">
      <div class="px-6 mb-8">
      ...
      <div x-show="open" x-cloak class="bg-teal-800 text-sm">
        ...
        <div class="relative">
          <button @click="window.location.href='tres-stall.php'" class="flex items-center w-full px-10 py-2 hover:bg-teal-600 focus:outline-none">
            ...
            <a href="tres-calendar.php" class="flex items-center px-6 py-3 bg-teal-700">
