  ...
  <div class="min-h-screen flex">
      ...
      <div class="bg-teal-800 text-white w-64 py-6 flex flex-col">
        ...
        <nav class="flex-1">
          ...
          <a href="homeowner-profile.php" class="flex items-center px-6 py-3 bg-teal-700">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 w-full">
          <div class="flex items-center space-x-6">
            ...
            <div>
              ...
              <p class="text-gray-600">Homeowner • Mabuhay Homes 2000</p>
            </div>
          </div>
        </div>
              ...
              <div class="info-row py-3 px-4 rounded-md">
                <div class="flex justify-between items-center">
                  <div>
                    ...
                    <p class="text-gray-900">Homeowner</p>
                  </div>
